...
describe('TodoDataService', () => {
  ...
  describe('#updateTodoById(id, values)', () => {
    ...
    it('sould return null if todo is not found', inject([TodoDataService], (service: TodoDataService) => {
      let todo = new Todo({title: 'Hello 1', complete: false});
      service.addTodo(todo);
  ...
  describe('#toggleTodoComplete(todo)', () => {
    ...
    it('sould return the updated todo with inverse complete status', inject([TodoDataService], (service: TodoDataService)=> {
      let todo = new Todo({title: 'Hello 1', complete: false});
      service.addTodo(todo);
